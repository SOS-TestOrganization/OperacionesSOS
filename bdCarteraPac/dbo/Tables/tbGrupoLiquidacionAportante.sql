CREATE TABLE [dbo].[tbGrupoLiquidacionAportante] (
    ...
    CONSTRAINT [PK_TbGrupoLiquidacionAportante] PRIMARY KEY CLUSTERED ([cnsctvo_grpo_lqdcn_aprtnte] ASC),
    CONSTRAINT [FK_tbGrupoLiquidacionAportante_TbGruposLiquidacion] FOREIGN KEY ([cnsctvo_cdgo_grpo_lqdcn]) REFERENCES [dbo].[tbGruposLiquidacion] ([cnsctvo_cdgo_grpo_lqdcn])
);


GO
/*--------------------------------------------------------------------------------------------------------
* Nombre                 	:	TrReferencia_Usuario_tbGrupoLiquidacionAportante
...
*------------------------------------------------------------------------------------------------------*/
CREATE TRIGGER  [dbo].[TrReferencia_Usuario_tbGrupoLiquidacionAportante]  ON    [dbo].[tbGrupoLiquidacionAportante] 
FOR  INSERT,UPDATE
AS
Begin
