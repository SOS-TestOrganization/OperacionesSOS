CREATE TABLE [dbo].[tbEstructuraCodigoBarras_Vigencias] (
    [cnsctvo_vgnca_estrctra_cdgo_brrs] [dbo].[udtConsecutivo] NOT NULL,
    [cnsctvo_estrctra_cdgo_brrs]       [dbo].[udtConsecutivo] NOT NULL,
    [cdgo_estrctra_cdgo_brrs]          [dbo].[udtCodigo]      NOT NULL,
    [dscrpcn_estrctra_cdgo_brrs]       [dbo].[udtDescripcion] NOT NULL,
    ...
    [idntfcdor_aplccn]                 CHAR (10)              NOT NULL,
    [cdgo_ps]                          CHAR (10)              NOT NULL,
    [cdgo_emprsa_iac]                  CHAR (10)              NOT NULL,
    [idntfccn_tpo_rcdo]                CHAR (10)              NOT NULL,
    [dgto_cntrl]                       CHAR (10)              NOT NULL,
    [idntfcdor_aplccn_usro]            CHAR (10)              NOT NULL,
    [idntfcdor_aplccn_usro_ia1]        CHAR (10)              NOT NULL,
    [idntfcdor_aplccn_usro_ia2]        CHAR (10)              NOT NULL,
    [tme_stmp]                         ROWVERSION             NOT NULL,
    CONSTRAINT [PK_TbtbEstructuraCodigoBarras_vigencias] PRIMARY KEY CLUSTERED ([cnsctvo_vgnca_estrctra_cdgo_brrs] ASC),
    CONSTRAINT [CKFinVigenciaMayorInicioVigencia_tbEstructuraCodigoBarras_Vigencias] CHECK ([fn_vgnca] >= [inco_vgnca]),
    CONSTRAINT [FK_tbEstructuraCodigoBarras_Vigencias_tbEstructuraCodigoBarras] FOREIGN KEY ([cnsctvo_estrctra_cdgo_brrs]) REFERENCES [dbo].[tbEstructuraCodigoBarras] ([cnsctvo_estrctra_cdgo_brrs]) ON DELETE CASCADE
);


GO
CREATE STATISTICS [cnsctvo_estrctra_cdgo_brrs]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([cnsctvo_estrctra_cdgo_brrs], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [cdgo_estrctra_cdgo_brrs]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([cdgo_estrctra_cdgo_brrs], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [dscrpcn_estrctra_cdgo_brrs]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([dscrpcn_estrctra_cdgo_brrs], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [inco_vgnca]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([inco_vgnca], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [fn_vgnca]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([fn_vgnca], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [fcha_crcn]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([fcha_crcn], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [usro_crcn]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([usro_crcn], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [obsrvcns]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([obsrvcns], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [vsble_usro]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([vsble_usro], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [idntfcdor_aplccn]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([idntfcdor_aplccn], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [cdgo_ps]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([cdgo_ps], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [cdgo_emprsa_iac]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([cdgo_emprsa_iac], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [idntfccn_tpo_rcdo]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([idntfccn_tpo_rcdo], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [dgto_cntrl]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([dgto_cntrl], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [idntfcdor_aplccn_usro]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([idntfcdor_aplccn_usro], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [idntfcdor_aplccn_usro_ia1]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([idntfcdor_aplccn_usro_ia1], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [idntfcdor_aplccn_usro_ia2]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([idntfcdor_aplccn_usro_ia2], [cnsctvo_vgnca_estrctra_cdgo_brrs]);


GO
CREATE STATISTICS [tme_stmp]
    ON [dbo].[tbEstructuraCodigoBarras_Vigencias]([tme_stmp]);
...
/*---------------------------------------------------------------------------------
* Nombre                 	: TrReferencia_tbEstructuraCodigoBarras_Vigencias
...
-----------------------------------------------------------------------------------*/
CREATE TRIGGER  [dbo].[TrReferencia_tbEstructuraCodigoBarras_Vigencias_usro_crcn]    ON    [dbo].[tbEstructuraCodigoBarras_Vigencias]
FOR  INSERT,UPDATE
AS
Begin
...
GO
/*---------------------------------------------------------------------------------
* Nombre		: TrValidaUpdateTraslapeCodigo_tbEstructuraCodigoBarras_Vigencias
...
* Fecha Modificacion	: <\FM  FM\>
-----------------------------------------------------------------------------------*/
CREATE TRIGGER  [dbo].[TrValidaUpdateTraslapeCodigo_tbEstructuraCodigoBarras_Vigencias] ON   [dbo].[tbEstructuraCodigoBarras_Vigencias]
FOR  UPDATE
AS
Begin
...
SELECT	@inco_vgnca = inco_vgnca,
		@fn_vgnca	= fn_vgnca,
		@Codigo_Consecutivo =  cnsctvo_estrctra_cdgo_brrs	,
		@cdgo_ara =  cdgo_estrctra_cdgo_brrs		
FROM   INSERTED

-->    Se capturan las variables que se estan modificando
SELECT     @dinco_vgnca   =  inco_vgnca,
	      @dfn_vgnca     =  fn_vgnca,
     	      @dcnsctvo_tbla  =  cnsctvo_estrctra_cdgo_brrs,
	      @cnsctvo_vgnca = cnsctvo_vgnca_estrctra_cdgo_brrs			     
FROM	deleted
...
if  Exists (select * from #tbValoresAnteriores d,  #tbValoresNuevos n
              ...
              and d.cnsctvo_vgnca_estrctra_cdgo_brrs = n.cnsctvo_vgnca_estrctra_cdgo_brrs )
...
-->Se Calcula si hay  traslape de fechas
	...
	FROM  tbEstructuraCodigoBarras_Vigencias p
	...
	And	p.cnsctvo_estrctra_cdgo_brrs = @Codigo_Consecutivo
...
-->Hay traslape de fechas
	Begin
		...
		And	convert(varchar(10),p.fn_vgnca,111)     >= convert(varchar(10),@fn_vgnca,111)))  
		And	p.cnsctvo_estrctra_cdgo_brrs = @Codigo_Consecutivo
  	      	and       p.cnsctvo_vgnca_estrctra_cdgo_brrs != @cnsctvo_vgnca
...
/*---------------------------------------------------------------------------------
* Nombre                 	: TrIncidencias_tbEstructuraCodigoBarras_Vigencias
...
* 			  <\D Cuando se actualiza un Campo de  TbEstructuraCodigoBarras_Vigencias  D\>
* Observaciones       	: <\O  O\>
* Parametros		: <\P   P\>
...
CREATE TRIGGER [dbo].[TrIncidencias_tbEstructuraCodigoBarras_Vigencias]   On [dbo].[tbEstructuraCodigoBarras_Vigencias]
For  UPDATE  As
...
--	set @inicio = GETDATE()
	...
	SET @nombre_tabla	= 'bdCarteraPac.DBO.TbEstructuraCodigoBarras_Vigencias'
			...
			BEGIN
				...
				BEGIN
					...
					IF @id_columna = 5
						...
						)SELECT 'bdCarteraPac', 'TbEstructuraCodigoBarras_Vigencias',@lcCampo,
						d.cnsctvo_vgnca_estrctra_cdgo_brrs, d.inco_vgnca, n.inco_vgnca,
						@lcUsuario,  @lcFechaIncidencia , d.cnsctvo_estrctra_cdgo_brrs
							FROM 	deleted d, inserted n 
						 WHERE 	d.cnsctvo_estrctra_cdgo_brrs = n.cnsctvo_estrctra_cdgo_brrs AND 
							(
							 (
					...
					ELSE 	IF @id_columna = 6
						...
						d.cnsctvo_vgnca_estrctra_cdgo_brrs, d.fn_vgnca, n.fn_vgnca,
						@lcUsuario,  @lcFechaIncidencia , d.cnsctvo_estrctra_cdgo_brrs
							FROM 	deleted d, inserted n 
						 WHERE 	d.cnsctvo_estrctra_cdgo_brrs = n.cnsctvo_estrctra_cdgo_brrs AND 
							(
...
GO
/*--------------------------------------------------------------------------------------------------------
*Metodo o Programa	: 	TrValidaModifiVigenciasRelacion_ttbEstructuraCodigoBarras_Vigencias
* Desarrollado por	:  <\A  	  Ing. Maribel Valencia Herrera			A\>
* Descripcion		:  <\D   Valida la modificiacion  de fechas de vigencia en la tabla Parámetro	 D\>
			   <\D	tbEstructuraCodigoBarras_Vigencias contra las tablas de relación			D\>
* Observaciones		:  <\O			O\>
* Parametros		 :  <\P    		P\>
...
* Fecha Modificacion	 : <\FM   FM\>
*---------------------------------------------------------------------------------*/
CREATE TRIGGER [dbo].[TrValidaModifiVigenciasRelacion_tbEstructuraCodigoBarras_Vigencias] ON   [dbo].[tbEstructuraCodigoBarras_Vigencias]
FOR UPDATE
AS 
Declare   
...
where tbla_prmtro='tbEstructuraCodigoBarras_Vigencias'

--> Se capturan las variables que se estan tratando de insertar
select  	@fcha_inco_vgnca = inco_vgnca,
	@fcha_fn_vgnca = fn_vgnca,
	@cnsctvo_tbla =  cnsctvo_estrctra_cdgo_brrs
from INSERTED
...
if  Exists (select * from #tbValoresAnteriores d,  #tbValoresNuevos n
              where   (convert(varchar(10),d.inco_vgnca,111)<>convert(varchar(10),n.inco_vgnca,111)
             		or convert(varchar(10),d.fn_vgnca,111)<>convert(varchar(10),n.fn_vgnca,111))
              and d.cnsctvo_estrctra_vgnca_brrs = n.cnsctvo_estrctra_vgnca_brrs)
...
--> Validar  si las vigencias modificadas afectan alguna relacion existente con la tabla  tbEstructuraCodigoBarras_Vigencias
...
--> Armar la cadena para saber si existe alguna relacion en la tabla Relacion con el  codigo de la  tabla tbEstructuraCodigoBarras y las fechas modificadas
...
--> Si  se encuentra en , por encima o por debajo del rango de la relacion no  actualiza e indica con cual opcion del menú esta relacionada el parámetro
			...
			If      @lncontador=0
				 ...
				 ROLLBACK TRANSACTION
	     			 select @mnsje  =  'Error, Existe una  Relacion entre los Parámetros tbEstructuraCodigoBarras_Vigencias  y  ' + @lcopcion_menu	
...
GO
/*---------------------------------------------------------------------------------------------------------------------------------------------------------------------
* Nombre		: TrCodigosEspeciales_tbEstructuraCodigoBarras_Vigencias
* Desarrollado por	: <\A Ing. Jorge Meneses					A\>
...
* Fecha Modificacion	: <\FM  									FM\>
---------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
CREATE TRIGGER [dbo].[TrCodigosEspeciales_tbEstructuraCodigoBarras_Vigencias]
ON  [dbo].[tbEstructuraCodigoBarras_Vigencias]
FOR  UPDATE, DELETE 
AS 
...
Select	@lcLongitud = (COL_LENGTH('tbEstructuraCodigoBarras_Vigencias ','cdgo_estrctra_cdgo_brrs')) - 1
...
If	Exists (	Select * From Deleted 
		Where cdgo_estrctra_cdgo_brrs = @lcCodigov  Or  cdgo_estrctra_cdgo_brrs =  @lcCodigoi)
Begin
	RollBack Transaction
...
GO
/*---------------------------------------------------------------------------------
* Nombre		: TrValidaTraslapeCodigo_tbEstructuraCodigoBarras_Vigencias
* Desarrollado por	: <\A Ing. Maribel Valencia Herrera				A\>
...
* Fecha Modificacion	: <\FM  FM\>
-----------------------------------------------------------------------------------*/
CREATE TRIGGER  [dbo].[TrValidaTraslapeCodigo_tbEstructuraCodigoBarras_Vigencias] ON   [dbo].[tbEstructuraCodigoBarras_Vigencias]
FOR  INSERT
AS
Begin
...
SELECT	@inco_vgnca = inco_vgnca,
		...
		@Codigo_Consecutivo = cnsctvo_estrctra_cdgo_brrs	,
		@cdgo_ara = cdgo_estrctra_cdgo_brrs		,
		@cdgo_vgnca	= cnsctvo_vgnca_estrctra_cdgo_brrs,
		@dscrpcn =  dscrpcn_estrctra_cdgo_brrs
FROM   INSERTED
...
-->Para Indicar al usuario contra que fecha hay traslape
		...
		And	convert(varchar(10),p.fn_vgnca,111)     >= convert(varchar(10),@fn_vgnca,111)))  
		And	p.cnsctvo_estrctra_cdgo_brrs =  @Codigo_Consecutivo
		and 	cnsctvo_vgnca_estrctra_cdgo_brrs !=  @cdgo_vgnca	
...
update tbEstructuraCodigoBarras set dscrpcn_estrctra_cdgo_brrs =  @dscrpcn
where cnsctvo_estrctra_cdgo_brrs = @Codigo_Consecutivo
