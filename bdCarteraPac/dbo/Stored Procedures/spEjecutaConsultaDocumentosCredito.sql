...
/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spEjecutaConsultaDocumentosCredito
...
*---------------------------------------------------------------------------------*/
CREATE PROCEDURE [dbo].[spEjecutaConsultaDocumentosCredito]
...
WHERE         a.cnsctvo_cdgo_tpo_nta			=		@lntipoNota	--notas Credito	
...
Select    dscrpcn_tpo_dcmnto,	 a.nmro_nta, 	dscrpcn_estdo_nta , a.vlr_nta  ,  a.cdgo_tpo_idntfccn, 	a.nmro_idntfccn, 			a.dscrpcn_clse_aprtnte,
	a.nmbre_scrsl, 	a.rzn_scl,	
	convert(char(20),replace(convert(char(20),a.fcha_crcn_nta,120),'-','/'))	 fcha_crcn_nta	,a.usro_crcn,sldo_nta,
...
Select @IcInstruccion	=  	'SELECT       dscrpcn_tpo_dcmnto,	 	nmro_nta    nmro_dcmto, 		dscrpcn_estdo_nta   dscrpcn_Estdo_dcmnto , 
					        sldo_nta  sldo_dcmnto , 			 	cdgo_tpo_idntfccn, 	nmro_idntfccn, 			dscrpcn_clse_aprtnte,
					        nmbre_scrsl, 			rzn_scl,			fcha_crcn ,
					        usro_crcn,		
				                     nmro_unco_idntfccn_empldr, 	cnsctvo_scrsl, 		cnsctvo_cdgo_clse_aprtnte, 	
					        cnsctvo_cdgo_tpo_nta,
					        cnsctvo_cdgo_estdo_nta , 		vlr_nta  Vlr_Dcmnto, 		dgto_vrfccn, a.fcha_crcn_nta '
