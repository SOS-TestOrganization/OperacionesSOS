/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spTraerPromotoresInformesGestion
...
*---------------------------------------------------------------------------------*/
CREATE    PROCEDURE	spTraerPromotoresInformesGestion
...
Select @Instruccion	=  	'Select     c.cdgo_prmtr,
				convert(varchar(200) , (ltrim(rtrim(isnull(c.prmr_aplldo,' +  Char(39) + ' ' + char(39) + '  ))) + '  +  Char(39)  +  ' '  + Char(39)   +  '  + ltrim(rtrim(isnull(c.sgndo_aplldo,' +  Char(39) + ' ' + char(39) + ' ))) + '  +  Char(39)  +  ' '  + Char(39)   + ' +  ltrim(rtrim(isnull(c.prmr_nmbre,' +  Char(39) + ' ' + char(39) + '))) + '  +  Char(39)  +  ' '  + Char(39)   +   ' +  ltrim(rtrim(isnull(c.sgndo_nmbre,' +  Char(39) + ' ' + char(39) + '))) + '   +    Char(39)  +  '  '  + Char(39)   +   ' +   ltrim(rtrim(isnull(c.rzn_scl,' +  Char(39) + ' ' + char(39) + ')))) ) dscrpcn_prmtr,
				c.inco_vgnca,
				c.fn_vgnca,
