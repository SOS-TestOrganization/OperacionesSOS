/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spConsultaNotasCreditoAplicadas
* Desarrollado por		: <\A Ing. ROLANDO SIMBAQUEVA LASSO								A\>
* Descripcion			: <\D Este procedimiento realiza la consulta de las notas credito en estado aplicada o aplicada parcial	  	D\>
* Observaciones			: <\O  													O\>
* Parametros			: <\P 													P\>
* Variables			: <\V  													V\>
...
CREATE PROCEDURE spConsultaNotasCreditoAplicadas
...
WHERE       (a.cnsctvo_cdgo_estdo_nta 			=		4  or 	a.cnsctvo_cdgo_estdo_nta = 7 )    --aplicada  o aplicada parcial
And	        a.cnsctvo_cdgo_tpo_nta			=		2	--notas Credito	
And	         1	=	2	
