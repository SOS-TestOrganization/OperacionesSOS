...
/*---------------------------------------------------------------------------------
* Metodo o PRG 	                	:  spRCCnsltaLiqRadRecobro
...
*---------------------------------------------------------------------------------*/
/*
exec spRCCnsltaLiqRadRecobro 1
*/

CREATE procedure spRCCnsLiqRadRcbroxEntddRcbrr
@CnsctvoEntddArcbrr			udtConsecutivo
...
--No. Liquidación,No.Radicación,Entidad a Recobrar,Entidad Reclamante,Nivel Complejidad,total
...
Select 	z.cnsctvo_asccn_lqdcn,
	...
	Where  z.cnsctvo_entdd_a_rcbrr = @CnsctvoEntddArcbrr
