...
/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spcr3EjecutaConsultaDocumentosCreditoXaplicar
...
CREATE PROCEDURE [dbo].[spcr3EjecutaConsultaDocumentosCreditoXaplicar]
			@NumeroNotaIni	Varchar(15),
			@NumeroNotaFin	Varchar(15)
...
And	        (a.nmro_nta > = @NumeroNotaIni 	and  	 a.nmro_nta  < =  @NumeroNotaFin)
