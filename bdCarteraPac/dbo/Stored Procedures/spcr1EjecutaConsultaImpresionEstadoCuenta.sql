/*---------------------------------------------------------------------------------
* Metodo o PRG   : spcr1EjecutaConsultaImpresionEstadoCuenta
...
* Nuevos Parametros  : <\PM  Empleador  y numero de liquidacionPM\>
...
*---------------------------------------------------------------------------------*/
CREATE PROCEDURE [dbo].[spcr1EjecutaConsultaImpresionEstadoCuenta]
(
	@nui				int,
	@numeroliquiini		int,
	@numeroliquifin		int
...
Begin
	...
	WHERE		(a.ttl_pgr > 0) AND (g.cnsctvo_cdgo_estdo_lqdcn = 3) 
	AND			a.nmro_unco_idntfccn_empldr   =  @nui
	AND			a.cnsctvo_cdgo_lqdcn >= @numeroliquiini   and  a.cnsctvo_cdgo_lqdcn <= @numeroliquifin
