  /*---------------------------------------------------------------------------------  
* Metodo o PRG   : spCr1EjecutaConsultaNotasCredito  
...
* Descripcion    : <\DM   Criterio numero nota    DM\>  
* Nuevos Parametros    : <\PM   PM\>  
* Nuevas Variables   : <\VM   VM\>  
* Fecha Modificacion   : <\FM   30/08/2005    FM\>  
*---------------------------------------------------------------------------------  
* Modificado Por   : <\AM   Andres Camelo (illustrato ltda) AM\>  
* Descripcion    : <\DM   modificado para que consulte las nota credito y notas credito REI   DM\>  
* Nuevos Parametros    : <\PM   PM\>  
* Nuevas Variables   : <\VM   VM\>  
* Fecha Modificacion   : <\FM   19/11/2013    FM\>  
*---------------------------------------------------------------------------------*/  
CREATE  PROCEDURE [dbo].[spCr1EjecutaConsultaNotasCredito]     
