/*---------------------------------------------------------------------------------
* Metodo o PRG	: spPlanoIndulicores
* Desarrollado por	: <\A Ing. Fernando Valncia							A\>
* Descripcion		: <\D Este procedimiento crea la informacion del archivo de Indulicores  	D\>
* Observaciones	: <\O  										O\>
* Parametros		: <\P										P\>
* Variables		: <\V  										V\>
* Fecha Creacion	: <\FC 2006/04/26								FC\>
*
*---------------------------------------------------------------------------------
...
CREATE  PROCEDURE spPlanoIndulicores
...
Create	Table #tmp1
	...
	fcha_ncmnto datetime,           dscrpcn_pln 	 varchar(150),  
	cnsctvo_scrsl int,		inco_vgnca_bnfcro datetime)
...
Set	prntsco = x.cnsctvo_cdgo_prntsco,
	inco_vgnca_bnfcro=x.inco_vgnca_bnfcro
...
Update	#tmp1
Set	dscrpcn_pln	= ltrim(rtrim(b.dscrpcn_pln))
From	#tmp1 a Inner Join
	bdPlanbeneficios.dbo.tbPlanes b
On	a.cnsctvo_cdgo_pln	=	b.cnsctvo_cdgo_pln


select 	tpo_idntfccn_ctznte,		nmro_idntfccn_ctznte, 		nmbre_ctznte,
	tpo_idntfccn_bnfcro,		nmro_idntfccn_bnfcro,		nmbre_bnfcro,
	prntsco,			dscrpcn_prntsco,		Vlr,	
	cnsctvo_scrsl,			nmro_cntrto,	 		cnsctvo_cdgo_tpo_cntrto,
	Nmro_estdo_cnta,		nmro_unco_idntfccn_bnfcro,	cnsctvo_bnfcro ,
	convert(char(10),fcha_ncmnto,111) 		as fcha_ncmnto,
	convert(char(10),inco_vgnca_bnfcro,111) 	as inco_vgnca_bnfcro,
	cdgo_pln,			dscrpcn_pln,			edd,			
	nui_ctznte				
from #tmp1
