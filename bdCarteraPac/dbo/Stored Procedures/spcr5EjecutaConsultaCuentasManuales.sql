...
/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spcr5EjecutaConsultaCuentasManuales
...
* Nuevos Parametros		: <\PM Empleador y fecha de creacion  PM\>
* Nuevas Variables		: <\VM  VM\>
* Fecha Modificacion		: <\FM  2005 / 08 / 25 FM\>
*---------------------------------------------------------------------------------*/
CREATE  PROCEDURE [dbo].[spcr5EjecutaConsultaCuentasManuales]
			@Nui		int,
			@ldfechaIni	Datetime,
			@ldFechaFin	Datetime

As  declare 	@nmro_idntfccn  Varchar(20)

Set Nocount On

Select 	@nmro_idntfccn = nmro_idntfccn
...
create table #tmpEstadosCuenta
 (	nmro_estdo_cnta			varchar(15),			cdgo_tpo_idntfccn			varchar(3),		nmro_idntfccn_rspnsble_pgo	varchar(20),
	dscrpcn_clse_aprtnte	varchar(50),			nmbre_scrsl					varchar(200),	nmbre_empldr				varchar(200),
	...
	dgto_vrfccn				int,					cts_cnclr					int,			drccn						varchar(100) , 
	cnsctvo_cdgo_cdd		int,					tlfno						varchar(20),	vlr_iva						numeric(12,0),							
	sldo_fvr				numeric(12,0),			ttl_pgr						numeric(12,0),	fcha_crcn					datetime, 
	cnsctvo_cdgo_prdo		int,					cnsctvo_cdgo_autrzdr_espcl	int,			prcntje_incrmnto			numeric (12,3),
	cnsctvo_cdgo_prdo_lqdcn int,					cnsctvo_cdgo_estdo_estdo_cnta int,			dscrpcn_tpo_idntfccn		varchar(50), 
	cdgo_clse_aprtnte		varchar(2),				cdgo_prdo					varchar(2),		dscrpcn_prdo				varchar(60),
	cdgo_prdo_lqdcn			varchar(4),				dscrpcn_prdo_lqdcn			varchar(60),	cdgo_estdo_estdo_cnta		varchar(2),
	Usro_atrzdr				varchar(200),			cdgo_autrzdr_espcl			varchar(30),	exste_cntrto				varchar(1)	)
...
where	(datediff(dd,@ldfechaIni,a.fcha_crcn)>=0  And datediff(dd,a.fcha_crcn,@ldFechaFin)>=0 )
And	@nmro_idntfccn	= 	a.nmro_idntfccn_rspnsble_pgo
