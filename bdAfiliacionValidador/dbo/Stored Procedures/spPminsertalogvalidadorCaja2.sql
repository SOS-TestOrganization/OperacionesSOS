...
*/
CREATE	procedure spPminsertalogvalidadorCaja2
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spPminsertalogvalidadorCaja2] TO [Validador de Prestaciones Medicas]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spPminsertalogvalidadorCaja2] TO [Consultor Servicio al Cliente]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spPminsertalogvalidadorCaja2] TO [Auxiliar Prestaciones Medicas y Validacion de Derechos]
    AS [dbo];
