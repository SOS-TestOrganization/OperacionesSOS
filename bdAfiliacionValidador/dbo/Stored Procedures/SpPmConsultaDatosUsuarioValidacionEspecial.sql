...
/*---------------------------------------------------------------------------------
* Metodo o PRG 	             	 :   SpCUConsultaDatosUsuarioValidacionEspecial
...
*---------------------------------------------------------------------------------*/
CREATE procedure  SpPmConsultaDatosUsuarioValidacionEspecial
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [310018 Auditor Salud Central]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Administrador Notificaciones Atep SOA]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Auditor Autorizador CNA]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Auxiliar de Prestaciones Medicas]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Coordinador de Prestaciones Medicas]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Validador de Prestaciones Medicas]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Auxiliar Tesoreria Prestaciones Medicas]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Analista Seguros Asistenciales]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Auditor Salud]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Consultor Salud]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Autorizadora Notificacion]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Auxiliar Sipres Analista Notificaciones]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Auditoria Interna Salud]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Coordinador Juridico Notificaciones]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Consultor Servicio al Cliente]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Analista Red Servicios]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Auxiliar Prestaciones Medicas y Validacion de Derechos]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SpPmConsultaDatosUsuarioValidacionEspecial] TO [Auxiliar de Prestaciones Centelsa]
    AS [dbo];
