...
*/
CREATE	procedure spPminsertalogvalidadorCajaAngela
...
Exec [Newton\actuario].[bdPrestaMedicas].[dbo].spinsertalogvalidadorCaja
		@cdgo_ofcna,
		@nmro_vrfcn output,
		@ofcna_usro output,
		@cdgo_usro, 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spPminsertalogvalidadorCajaAngela] TO [Validador de Prestaciones Medicas]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spPminsertalogvalidadorCajaAngela] TO [Consultor Servicio al Cliente]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spPminsertalogvalidadorCajaAngela] TO [Auxiliar Prestaciones Medicas y Validacion de Derechos]
    AS [dbo];
