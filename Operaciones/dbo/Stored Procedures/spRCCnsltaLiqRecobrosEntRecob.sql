...
/*---------------------------------------------------------------------------------
* Metodo o PRG 	                	:  spRCCnsltaLiqRecobrosEntRecob
* Desarrollado por		 	: <\A Ing. Flor Liliana Cobo T.							A\>
* Descripcion			  	: <\D 											D\>
* Observaciones		          		: <\O											O\>
* Parametros			  	: <\P 											P\>
* Variables			  	: <\V  											V\>
* Fecha Creacion	          		: <\FC 2005/06/02									FC\>
*
*---------------------------------------------------------------------------------
...
*---------------------------------------------------------------------------------*/
/*
exec spRCCnsltaLiqRecobrosEntRecob 1
*/

CREATE procedure spRCCnsltaLiqRecobrosEntRecob
@cnsctvocdgoentddarcbrr		udtConsecutivo
...
Select 	z.cnsctvo_asccn_lqdcn,
	...
	Where  z.cnsctvo_entdd_a_rcbrr = @cnsctvocdgoentddarcbrr	
