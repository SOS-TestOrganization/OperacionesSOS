...
/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spCr5EjecutaConsultaPagosManuales
...
* Descripcion			 : <\DM   Criterio empleador y fecha de recaudo		DM\>
* Nuevos Parametros	 	 : <\PM   PM\>
* Nuevas Variables		 : <\VM   VM\>
* Fecha Modificacion		 : <\FM   29/08/2005					FM\>
*---------------------------------------------------------------------------------*/
CREATE PROCEDURE [dbo].[spCr5EjecutaConsultaPagosManuales]
@nmro_unco_idntfccn_empldr udtConsecutivo,@fcha_rcdo_ini datetime, @fcha_rcdo_fn datetime
As
...
And		datediff(dd,@fcha_rcdo_ini,a.fcha_rcdo)>= 0
And		datediff(dd,a.fcha_rcdo,@fcha_rcdo_fn) >= 0 
