...
/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spcr6EjecutaConsultaReintegros
...
*
*---------------------------------------------------------------------------------*/
CREATE   PROCEDURE [dbo].[spcr6EjecutaConsultaReintegros]
	@lnnmro_unco_idntfccn_bnfcro		udtConsecutivo
...
into #NotasComtrato
from tbNotasContrato a,tbNotasBeneficiariosContratos b
WHERE a.cnsctvo_cdgo_tpo_nta = 3  			
and a.cnsctvo_nta_cntrto = b.cnsctvo_nta_cntrto
and	a.cnsctvo_cdgo_tpo_cntrto	=	2
and b.nmro_unco_idntfccn_bnfcro = @lnnmro_unco_idntfccn_bnfcro
...
WHERE       a.cnsctvo_cdgo_tpo_nta			=	3 
and datediff(dd,h.inco_vgnca,@ldfechaSistema)>=0  And datediff(dd,@ldfechaSistema,h.fn_vgnca)>=0 
