...
/*---------------------------------------------------------------------------------
* Metodo o PRG 	                	:  spRCCnsltaLiqRecobrosPcnte
...
*---------------------------------------------------------------------------------*/
/*
exec spRCCnsltaLiqRecobrosPcnte 1,'10386287'
*/

CREATE procedure spRCCnsltaLiqRecobrosPcnte
@CnsctvoCdgoTpoIdntfccn			udtConsecutivo,
@NmroIdntfccn			udtNumeroIdentificacionLargo
...
Select 	z.cnsctvo_asccn_lqdcn,
	...
	Where  a.cnsctvo_cdgo_tpo_idntfccn_pcnte = @CnsctvoCdgoTpoIdntfccn	
	and a.nmro_idntfccn_pcnte = @NmroIdntfccn
