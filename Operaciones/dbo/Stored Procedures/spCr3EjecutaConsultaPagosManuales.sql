...
/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spCr3EjecutaConsultaPagosManuales
...
* Descripcion			 : <\DM   Criterio fecha recaudo	    	    DM\>
* Nuevos Parametros	 	 : <\PM   PM\>
* Nuevas Variables		 : <\VM   VM\>
* Fecha Modificacion		 : <\FM   26/08/2005				    FM\>
*---------------------------------------------------------------------------------*/
CREATE PROCEDURE [dbo].[spCr3EjecutaConsultaPagosManuales]
@fcha_rcdo_ini datetime, @fcha_rcdo_fn datetime
As
...
Where		datediff(dd,@fcha_rcdo_ini,a.fcha_rcdo)>= 0
