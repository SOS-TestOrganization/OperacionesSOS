...
/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spCr3EjecutaConsultaNotasCreditoImpuestos
...
*---------------------------------------------------------------------------------*/
CREATE PROCEDURE [dbo].[spCr3EjecutaConsultaNotasCreditoimpuestos]			
...
And	a.cnsctvo_cdgo_tpo_nta		=	4	--Impuestos 	
