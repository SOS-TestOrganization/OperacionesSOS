...
* Observaciones		: <\O  								O\>
* Parametros		: <\P Tipo proceso						P\>
*			  <\P Fecha creación desde					P\>
*			  <\P Fecha creación hasta					P\>
* Variables		: <\V								V\>
...
*---------------------------------------------------------------------------------*/
CREATE  PROCEDURE spcr1EjecutaConsultaLiquidaciones
@lnTipoProceso Int,
...
Where	d.cnsctvo_cdgo_tpo_prcso	= @lnTipoProceso
And	Datediff(Day,@ldFechaCreacionDesde,a.fcha_crcn)	>= 0
