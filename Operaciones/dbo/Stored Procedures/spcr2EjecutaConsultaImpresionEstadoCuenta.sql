...
/*---------------------------------------------------------------------------------
* Metodo o PRG   : spcr2EjecutaConsultaImpresionEstadoCuenta
...
* Nuevos Parametros  : <\PM  Sede  y numero de liquidacionPM\>
...
*---------------------------------------------------------------------------------*/
CREATE PROCEDURE [dbo].[spcr2EjecutaConsultaImpresionEstadoCuenta]
(
	@sede				int,
	@numeroliquiini		int,
	@numeroliquifin		int
