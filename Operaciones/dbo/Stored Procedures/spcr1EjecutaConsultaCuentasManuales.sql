...
/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spcr1EjecutaConsultaCuentasManuales
...
* Nuevos Parametros		: <\PM  numero de estado de cuenta inicial y final  PM\>
* Nuevas Variables		: <\VM  VM\>
* Fecha Modificacion		: <\FM  2005 / 08 / 25 FM\>
*---------------------------------------------------------------------------------*/
--exec [spcr1EjecutaConsultaCuentasManuales] '1242837','1242837'

CREATE  PROCEDURE [dbo].[spcr1EjecutaConsultaCuentasManuales]
			@NumeroIni  varchar(15),
			@NumeroFin  varchar(15)
...
where	a.nmro_estdo_cnta > =  @NumeroIni and  a.nmro_estdo_cnta <= @NumeroFin
