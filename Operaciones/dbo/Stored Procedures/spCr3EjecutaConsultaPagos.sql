...
/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spCr3EjecutaConsultaPagos
...
* Descripcion			 : <\DM   Criterio tipo de pago y fecha de inteface DM\>
* Nuevos Parametros	 	 : <\PM   PM\>
* Nuevas Variables		 : <\VM   VM\>
* Fecha Modificacion		 : <\FM   25/08/2005				    FM\>
*---------------------------------------------------------------------------------*/
CREATE PROCEDURE [dbo].[spCr3EjecutaConsultaPagos]
...
And		datediff(dd,@fechaInterface1,fcha_crcn)>=0 
And		datediff(dd,fcha_crcn,@fechaInterface2)>=0
