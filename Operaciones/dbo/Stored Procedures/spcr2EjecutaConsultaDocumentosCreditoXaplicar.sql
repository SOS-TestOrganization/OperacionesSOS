...
/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spcr2EjecutaConsultaDocumentosCreditoXaplicar
...
CREATE PROCEDURE [dbo].[spcr2EjecutaConsultaDocumentosCreditoXaplicar]
			@Nui		int
