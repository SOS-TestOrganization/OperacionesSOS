...
/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spCr6EjecutaConsultaPagosManuales
...
* Parametros			: <\P													P\>
* Variables			: <\V  													V\>
* Fecha Creacion		: <\FC 2009/07/10											FC\>
*
*---------------------------------------------------------------------------------
...
*---------------------------------------------------------------------------------*/
CREATE PROCEDURE [dbo].[spCr6EjecutaConsultaPagosManuales]
...
Where		a.cnsctvo_cdgo_estdo_pgo = @cnsctvo_cdgo_estdo
