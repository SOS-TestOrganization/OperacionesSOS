...
/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spCr4EjecutaConsultaNotasCredito
...
*---------------------------------------------------------------------------------*/
CREATE  PROCEDURE [dbo].[spCr4EjecutaConsultaNotasCredito]			
 @fcha_crcn_desde datetime, @fcha_crcn_hasta datetime
As
Declare
...
WHERE  datediff(dd,@fcha_crcn_desde,a.fcha_crcn_nta)	>= 0
