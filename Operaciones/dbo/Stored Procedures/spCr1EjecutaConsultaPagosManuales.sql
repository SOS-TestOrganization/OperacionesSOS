...
/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spCr1EjecutaConsultaPagosManuales
...
* Descripcion			 : <\DM   Criterio numero del pago DM\>
* Nuevos Parametros	 	 : <\PM   PM\>
* Nuevas Variables		 : <\VM   VM\>
* Fecha Modificacion		 : <\FM   26/08/2005				    FM\>
*---------------------------------------------------------------------------------*/
CREATE PROCEDURE [dbo].[spCr1EjecutaConsultaPagosManuales]
@cnsctvo_cdgo_pgo_desde int, @cnsctvo_cdgo_pgo_hasta int
As
...
where	 	a.cnsctvo_cdgo_pgo >= @cnsctvo_cdgo_pgo_desde
And 		a.cnsctvo_cdgo_pgo <= @cnsctvo_cdgo_pgo_hasta
