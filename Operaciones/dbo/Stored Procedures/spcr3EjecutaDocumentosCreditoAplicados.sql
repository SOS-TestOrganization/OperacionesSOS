...
/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spcr3EjecutaDocumentosCreditoAplicados
* Desarrollado por		: <\A Ing. Andres camelo (illustrato ltda)							A\>
* Descripcion			: <\D Este procedimiento trae la informacion de las notas credito REI aplicados			  	D\>
* Observaciones			: <\O  													O\>
* Parametros			: <\P 													P\>
* Variables			: <\V  													V\>
...
CREATE PROCEDURE [dbo].[spcr3EjecutaDocumentosCreditoAplicados]
