/*---------------------------------------------------------------------------------
* Metodo o PRG   : spcr3EjecutaConsultaCuentasManuales
...
* Nuevos Parametros  : <\PM fecha de creacion inicial y final   PM\>
* Nuevas Variables  : <\VM  VM\>
* Fecha Modificacion  : <\FM  2005 / 08 / 25 FM\>
*---------------------------------------------------------------------------------*/
CREATE PROCEDURE spcr3EjecutaConsultaCuentasManuales
   @ldfechaIni Datetime,
   @ldFechaFin Datetime
...
create table #tmpEstadosCuenta
 ( nmro_estdo_cnta varchar(15),  cdgo_tpo_idntfccn varchar(3), nmro_idntfccn_rspnsble_pgo varchar(20),
   ...
   dgto_vrfccn int, cts_cnclr int, drccn varchar(150) , cnsctvo_cdgo_cdd int,
   tlfno varchar(30),  vlr_iva numeric(12,0) , sldo_fvr numeric(12,0),
