...
/*---------------------------------------------------------------------------------  
* Metodo o PRG   : spConsultaNotasCredito  
* Desarrollado por  : <\A Ing. Andres camelo (illustrato ltda)        A\>  
* Descripcion   : <\D Retorna los datos de la notas credito y notas credito REI           D\>  
* Observaciones   : <\O               O\>  
* Parametros   : <\P @lConsecutivonota consecutivo nota         P\>  
                 <\P @lcEstadoNota   estado de la nota       P\>       
                 <\P @ldFechaReferencia   fecha referencia    P\>       
* Variables   : <\V               V\>  
* Fecha Creacion  : <\FC 2013/11/19           FC\>  
*  
*---------------------------------------------------------------------------------  
*---------------------------------------------------------------------------------
...
*---------------------------------------------------------------------------------*/ 
--exec [spConsultaNotasCredito] 91253,5,null,'3,6' 
CREATE PROCEDURE [dbo].[spConsultaNotasCredito]  
...
And         a.cnsctvo_cdgo_tpo_nta in (2,6)
