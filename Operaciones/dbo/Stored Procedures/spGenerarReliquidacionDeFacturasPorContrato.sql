...
*-----------------------------------------------------------------------------------------------------------------------------------*/
--exec spGenerarReliquidacionDeFacturasPorContrato 94525889,8
CREATE procedure [dbo].[spGenerarReliquidacionDeFacturasPorContrato]
(
...
begin
	...
	inner join			BDCarteraPAC.dbo.tbEstadosCuenta z with(nolock)
