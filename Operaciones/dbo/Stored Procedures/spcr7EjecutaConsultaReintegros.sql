...
/*---------------------------------------------------------------------------------
* Metodo o PRG 			: spcr7EjecutaConsultaReintegros
* Desarrollado por		: <\A Ing. Rolando simbaqueva Lasso									A\>
* Descripcion			: <\D Ejecuta la nueva forma de criterios	D\>
* Observaciones			: <\O  													O\>
* Parametros			: <\P													P\>
* Variables			: <\V  													V\>
* Fecha Creacion		: <\FC 2010 / 10 / 01											FC\>
*
*---------------------------------------------------------------------------------
...
*---------------------------------------------------------------------------------*/
CREATE   PROCEDURE [dbo].[spcr7EjecutaConsultaReintegros]
	@lnestado				int
...
And	  a.cnsctvo_cdgo_estdo_nta		=	@lnestado	
