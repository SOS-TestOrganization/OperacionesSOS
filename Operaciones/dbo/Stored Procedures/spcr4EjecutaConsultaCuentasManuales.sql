...
/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spcr4EjecutaConsultaCuentasManuales
...
* Nuevos Parametros		: <\PM usuario creacion, fecha de creacion inicial y final   PM\>
* Nuevas Variables		: <\VM  VM\>
* Fecha Modificacion		: <\FM  2005 / 08 / 25 FM\>
*---------------------------------------------------------------------------------*/
CREATE  PROCEDURE spcr4EjecutaConsultaCuentasManuales
