...
/*---------------------------------------------------------------------------------
* Metodo o PRG 		: spcr2EjecutaDocumentosCreditoAplicados
...
* Observaciones			: <\O  	Numero de la nota											O\>
* Parametros			: <\P 													P\>
* Variables			: <\V  													V\>
* Fecha Creacion		: <\FC 2004/08/22 											FC\>
**/

CREATE PROCEDURE [dbo].[spcr2EjecutaDocumentosCreditoAplicados]
...
WHERE     (a.cnsctvo_cdgo_estdo_nta = 4 OR
                      a.cnsctvo_cdgo_estdo_nta = 7) AND (a.usro_crcn <> 'Migracion01') AND (a.fcha_crcn_nta >= '20040209') AND (b.cnsctvo_cdgo_tpo_dcmnto = 3) AND 
                      (a.cnsctvo_cdgo_tpo_nta = 2)
