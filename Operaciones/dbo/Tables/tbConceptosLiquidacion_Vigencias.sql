CREATE TABLE [dbo].[tbConceptosLiquidacion_Vigencias] (
    [cnsctvo_vgnca_cncpto_lqdcn]          [dbo].[udtConsecutivo]    NOT NULL,
    [cnsctvo_cdgo_cncpto_lqdcn]           [dbo].[udtConsecutivo]    NOT NULL,
    [cdgo_cncpto_lqdcn]                   CHAR (5)                  NOT NULL,
    [dscrpcn_cncpto_lqdcn]                [dbo].[udtDescripcion]    NOT NULL,
    ...
    [cnsctvo_cdgo_tpo_mvmnto]             [dbo].[udtConsecutivo]    NOT NULL,
    [oprcn]                               [dbo].[udtConsecutivo]    NOT NULL,
    [prcntje]                             [dbo].[udtValorDecimales] NOT NULL,
    [cnsctvo_cdgo_bse_aplcda]             [dbo].[udtConsecutivo]    NOT NULL,
    [cnsctvo_cdgo_tpo_cncpto_opsto_lqdcn] [dbo].[udtConsecutivo]    NULL,
    [slcta_atrzdr]                        CHAR (1)                  NOT NULL,
    [tme_stmp]                            ROWVERSION                NOT NULL,
    [prcntje_min]                         [dbo].[udtValorDecimales] NULL,
    CONSTRAINT [PK_TbConceptosliquidacion01] PRIMARY KEY CLUSTERED ([cnsctvo_vgnca_cncpto_lqdcn] ASC) WITH (FILLFACTOR = 90),
    CONSTRAINT [CKFinVigenciaMayorInicioVigencia_tbConceptosLiquidacion_Vigencias02] CHECK ([fn_vgnca]>=[inco_vgnca]),
    CONSTRAINT [FK_tbConceptosLiquidacion_Vigencias02_tbBasesAplicadas] FOREIGN KEY ([cnsctvo_cdgo_bse_aplcda]) REFERENCES [dbo].[tbBasesAplicadas] ([cnsctvo_cdgo_bse_aplcda]),
    CONSTRAINT [FK_tbConceptosLiquidacion_Vigencias02_tbConceptosliquidacion1] FOREIGN KEY ([cnsctvo_cdgo_cncpto_lqdcn]) REFERENCES [dbo].[tbConceptosLiquidacion] ([cnsctvo_cdgo_cncpto_lqdcn]) ON DELETE CASCADE,
    CONSTRAINT [FK_tbConceptosLiquidacion_Vigencias02_tbTiposMovimiento] FOREIGN KEY ([cnsctvo_cdgo_tpo_mvmnto]) REFERENCES [dbo].[tbTiposMovimiento] ([cnsctvo_cdgo_tpo_mvmnto])
);


GO
CREATE STATISTICS [fcha_crcn]
    ON [dbo].[tbConceptosLiquidacion_Vigencias]([fcha_crcn]);


GO
CREATE STATISTICS [usro_crcn]
    ON [dbo].[tbConceptosLiquidacion_Vigencias]([usro_crcn]);


GO
CREATE STATISTICS [obsrvcns]
    ON [dbo].[tbConceptosLiquidacion_Vigencias]([obsrvcns]);


GO
CREATE STATISTICS [oprcn]
    ON [dbo].[tbConceptosLiquidacion_Vigencias]([oprcn]);


GO
CREATE STATISTICS [prcntje]
    ON [dbo].[tbConceptosLiquidacion_Vigencias]([prcntje]);


GO
CREATE STATISTICS [cnsctvo_cdgo_tpo_cncpto_opsto_lqdcn]
    ON [dbo].[tbConceptosLiquidacion_Vigencias]([cnsctvo_cdgo_tpo_cncpto_opsto_lqdcn]);


GO
CREATE STATISTICS [slcta_atrzdr]
    ON [dbo].[tbConceptosLiquidacion_Vigencias]([slcta_atrzdr]);
...
/*---------------------------------------------------------------------------------
* Nombre                 	: TrIncidencias_tbConceptosLiquidacion_Vigencias02
...
* 			  <\D Cuando se actualiza un Campo de tbConceptosLiquidacion_Vigencias D\>
* Observaciones       	: <\O  O\>
* Parametros		: <\P   P\>
...
CREATE TRIGGER [dbo].[TrIncidencias_tbConceptosLiquidacion_Vigencias02]  On  [dbo].[tbConceptosLiquidacion_Vigencias]
For  UPDATE  As
...
--	set @inicio = GETDATE()
	...
	SET @nombre_tabla	= 'bdCarteraPac.DBO.tbConceptosLiquidacion_Vigencias'
			...
			BEGIN
				...
				BEGIN
					...
					IF @id_columna = 5
						...
						)SELECT 'bdCarteraPac', 'tbConceptosLiquidacion_Vigencias',@lcCampo,
						d.cnsctvo_vgnca_cncpto_lqdcn, d.inco_vgnca, n.inco_vgnca,
						@lcUsuario,  @lcFechaIncidencia , d.cnsctvo_cdgo_cncpto_lqdcn
							FROM 	deleted d, inserted n 
						 WHERE 	d.cnsctvo_cdgo_cncpto_lqdcn = n.cnsctvo_cdgo_cncpto_lqdcn AND 
							(
							 (
					...
					ELSE 	IF @id_columna = 6
						...
						d.cnsctvo_vgnca_cncpto_lqdcn, d.fn_vgnca, n.fn_vgnca,
						@lcUsuario,  @lcFechaIncidencia , d.cnsctvo_cdgo_cncpto_lqdcn
							FROM 	deleted d, inserted n 
						 WHERE 	d.cnsctvo_cdgo_cncpto_lqdcn = n.cnsctvo_cdgo_cncpto_lqdcn AND 
							(
...
GO
DISABLE TRIGGER [dbo].[TrIncidencias_tbConceptosLiquidacion_Vigencias02]
    ON [dbo].[tbConceptosLiquidacion_Vigencias];
...
*---------------------------------------------------------------------------------*/
CREATE TRIGGER  [dbo].[TrReferencia_tbConceptosLiquidacion_Vigencias02]    ON [dbo].[tbConceptosLiquidacion_Vigencias]
FOR  INSERT,UPDATE
AS
Begin
...
If Not Exists (Select p.cnsctvo_cdgo_pln
	...
	Begin
		...
		select @lcmnsje  =  'Error:,  Violación de Integridad Referencial con bdplanBeneficios..tbplanes'
...
GO
DISABLE TRIGGER [dbo].[TrReferencia_tbConceptosLiquidacion_Vigencias02]
    ON [dbo].[tbConceptosLiquidacion_Vigencias];


GO
/*---------------------------------------------------------------------------------------------------------------------------------------------------------------------
* Nombre		: TrCodigosEspeciales_tbConceptosLiquidacion_Vigencias02
* Desarrollado por	: <\A Ing. Jorge Meneses					A\>
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
CREATE TRIGGER [dbo].[TrCodigosEspeciales_tbConceptosLiquidacion_Vigencias02]
ON  [dbo].[tbConceptosLiquidacion_Vigencias]
FOR  UPDATE, DELETE 
AS 
...
Select	@lcLongitud = (COL_LENGTH('tbConceptosLiquidacion_Vigencias02 ','cdgo_cncpto_lqdcn')) - 1
...
If	Exists (	Select * From Deleted 
		Where cdgo_cncpto_lqdcn = @lcCodigov  Or  cdgo_cncpto_lqdcn =  @lcCodigoi)
Begin
	RollBack Transaction
...
GO
DISABLE TRIGGER [dbo].[TrCodigosEspeciales_tbConceptosLiquidacion_Vigencias02]
    ON [dbo].[tbConceptosLiquidacion_Vigencias];


GO
/*---------------------------------------------------------------------------------
* Nombre                 	: TrReferencia_tbConceptosLiquidacion_Vigencias02
* Desarrollado por	: <\A Ing. Jorge Meneses  A\>
...
* Fecha Modificacion	: <\FM  FM\>
-----------------------------------------------------------------------------------*/
CREATE TRIGGER  [dbo].[TrReferencia_tbConceptosLiquidacion_Vigencias02_usro_crcn]    ON    [dbo].[tbConceptosLiquidacion_Vigencias]
FOR  INSERT,UPDATE
AS
Begin
...
GO
DISABLE TRIGGER [dbo].[TrReferencia_tbConceptosLiquidacion_Vigencias02_usro_crcn]
    ON [dbo].[tbConceptosLiquidacion_Vigencias];


GO
/*--------------------------------------------------------------------------------------------------------
*Metodo o Programa	: 	TrValidaModifiVigenciasRelacion_ttbConceptosLiquidacion_Vigencias02
* Desarrollado por	:  <\A  	  Ing. Maribel Valencia Herrera			A\>
* Descripcion		:  <\D   Valida la modificiacion  de fechas de vigencia en la tabla Parámetro	 D\>
			   <\D	tbConceptosLiquidacion_Vigencias02 contra las tablas de relación			D\>
* Observaciones		:  <\O			O\>
* Parametros		 :  <\P    		P\>
...
* Fecha Modificacion	 : <\FM   FM\>
*---------------------------------------------------------------------------------*/
CREATE TRIGGER [dbo].[TrValidaModifiVigenciasRelacion_tbConceptosLiquidacion_Vigencias02] ON   [dbo].[tbConceptosLiquidacion_Vigencias]
FOR UPDATE
AS 
Declare   
...
if  Exists (select * from #tbValoresAnteriores d,  #tbValoresNuevos n
              ...
              and d.cnsctvo_vgnca_cncpto_lqdcn = n.cnsctvo_vgnca_cncpto_lqdcn)
...
--> Validar  si las vigencias modificadas afectan alguna relacion existente con la tabla  tbConceptosLiquidacion_Vigencias02
...
--> Armar la cadena para saber si existe alguna relacion en la tabla Relacion con el  codigo de la  tabla tbConceptosliquidacion y las fechas modificadas
...
--> Si  se encuentra en , por encima o por debajo del rango de la relacion no  actualiza e indica con cual opcion del menú esta relacionada el parámetro
			...
			If      @lncontador=0
				 ...
				 ROLLBACK TRANSACTION
	     			 select @mnsje  =  'Error, Existe una  Relacion entre los Parámetros tbConceptosLiquidacion_Vigencias02  y  ' + @lcopcion_menu	
...
GO
DISABLE TRIGGER [dbo].[TrValidaModifiVigenciasRelacion_tbConceptosLiquidacion_Vigencias02]
    ON [dbo].[tbConceptosLiquidacion_Vigencias];
...
/*---------------------------------------------------------------------------------
* Nombre		: TrValidaTraslapeCodigo_tbConceptosLiquidacion_Vigencias02
* Desarrollado por	: <\A Ing. Maribel Valencia Herrera				A\>
...
* Fecha Modificacion	: <\FM  FM\>
-----------------------------------------------------------------------------------*/
CREATE TRIGGER  [dbo].[TrValidaTraslapeCodigo_tbConceptosLiquidacion_Vigencias02] ON   [dbo].[tbConceptosLiquidacion_Vigencias]
FOR  INSERT
AS
Begin
...
SELECT	@inco_vgnca = inco_vgnca,
		@fn_vgnca	= fn_vgnca,
		@Codigo_Consecutivo = cnsctvo_cdgo_cncpto_lqdcn	,
		@cdgo_ara = cdgo_cncpto_lqdcn		,
		@cdgo_vgnca	= cnsctvo_vgnca_cncpto_lqdcn,
		@dscrpcn =  dscrpcn_cncpto_lqdcn
FROM   INSERTED

	
-->Se Calcula si hay  traslape de fechas
	SELECT @contador = count(*)
	FROM  tbConceptosLiquidacion_Vigencias p
	...
	And	p.cnsctvo_cdgo_cncpto_lqdcn = @Codigo_Consecutivo
...
-->Para Indicar al usuario contra que fecha hay traslape
		...
		And	convert(varchar(10),p.fn_vgnca,111)     >= convert(varchar(10),@fn_vgnca,111)))  
		And	p.cnsctvo_cdgo_cncpto_lqdcn =  @Codigo_Consecutivo
		and 	cnsctvo_vgnca_cncpto_lqdcn !=  @cdgo_vgnca	
...
update tbConceptosliquidacion set dscrpcn_cncpto_lqdcn =  @dscrpcn
where cnsctvo_cdgo_cncpto_lqdcn = @Codigo_Consecutivo
...
GO
DISABLE TRIGGER [dbo].[TrValidaTraslapeCodigo_tbConceptosLiquidacion_Vigencias02]
    ON [dbo].[tbConceptosLiquidacion_Vigencias];
...
/*---------------------------------------------------------------------------------
* Nombre		: TrValidaUpdateTraslapeCodigo_tbConceptosLiquidacion_Vigencias02
...
* Fecha Modificacion	: <\FM  FM\>
-----------------------------------------------------------------------------------*/
CREATE TRIGGER  [dbo].[TrValidaUpdateTraslapeCodigo_tbConceptosLiquidacion_Vigencias02] ON   [dbo].[tbConceptosLiquidacion_Vigencias]
FOR  UPDATE
AS
Begin
...
SELECT     @dinco_vgnca   =  inco_vgnca,
	      @dfn_vgnca     =  fn_vgnca,
     	      @dcnsctvo_tbla  =  cnsctvo_cdgo_cncpto_lqdcn,
	      @cnsctvo_vgnca = cnsctvo_vgnca_cncpto_lqdcn			     
FROM	deleted
...
--> Valida que el parametro a modificar sea vigente
		if  (convert(varchar(10),@dfn_vgnca,111) < convert(varchar(10),getDate(),111)  and 
				...
				RAISERROR(@mnsje,16,217) WITH LOG
...
-->Hay traslape de fechas
	Begin
		...
		And	convert(varchar(10),p.fn_vgnca,111)     >= convert(varchar(10),@fn_vgnca,111)))  
		And	p.cnsctvo_cdgo_cncpto_lqdcn = @Codigo_Consecutivo
  	      	and       p.cnsctvo_vgnca_cncpto_lqdcn != @cnsctvo_vgnca
...
GO
DISABLE TRIGGER [dbo].[TrValidaUpdateTraslapeCodigo_tbConceptosLiquidacion_Vigencias02]
    ON [dbo].[tbConceptosLiquidacion_Vigencias];
